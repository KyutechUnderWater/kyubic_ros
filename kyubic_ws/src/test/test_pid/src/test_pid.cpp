...
TestPID::TestPID(const rclcpp::NodeOptions & options) : Node("test_pid", options)
{
  ...
  sub_current_ = create_subscription<std_msgs::msg::Float32>(
    "current_pid", qos, std::bind(&TestPID::_callback_current, this, std::placeholders::_1));
  timer_ = create_wall_timer(1s, std::bind(&TestPID::update, this));
}
...
void TestPID::_callback_current(const std_msgs::msg::Float32::UniquePtr msg)
{
  current = msg->data;
}
